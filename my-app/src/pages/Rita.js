...
const Rita = (props) => {
    ...
    <h1 style={{textAlign: 'center', display: props.RitaCorruption===0 ? 'block' : 'none'}}>Threat Level: <span onClick={()=>{
        corrupt(2);
    }} class='interactive enabled-link-r no-select-text'>E</span></h1>
    <h1 style={{textAlign: 'center', display: props.RitaCorruption>=1 ? 'block' : 'none'}}>Threat Level: <b class='enabled-link-b'>E (Zeppeli Privilege)</b></h1>
    ...
    <h2 style={{display: props.RitaCorruption===2 ? 'block' : 'none'}}>Previous <span onClick={()=>{
        corrupt(2);
    }} class='interactive enabled-link-r no-select-text'>Names</span> and Aliases</h2>
    <h2 style={{display: props.RitaCorruption>=4 ? 'block' : 'none'}}>Previous <b class='enabled-link-b'>Markers of Fate</b> and Aliases</h2>
    ...
    <ul>
        ...
        corrupt(2);
    }} class='interactive enabled-link-r no-select-text'>prefers</span> the shorthand of her first name ‘Rita’</li>
    <li style={{display: props.RitaCorruption===6 ? 'list-item' : 'none'}}>Margarita Zeppeli - Zeppeli <b class='enabled-link-b'>Zeppeli</b> <span onClick={()=>{
        corrupt(2);
    }} class='interactive enabled-link-r no-select-text'>the</span> shorthand of her first name ‘Rita’</li>
    <li style={{display: props.RitaCorruption===8 ? 'list-item' : 'none'}}>Margarita Zeppeli - Zeppeli <b class='enabled-link-b'>Zeppeli</b> <b class='enabled-link-b'>Zeppeli </b>
    <span onClick={()=>{
        corrupt(2);
    }} class='interactive enabled-link-r no-select-text'>shorthand of her first name ‘Rita’</span></li>
    <li style={{display: props.RitaCorruption===10 ? 'list-item' : 'none'}}>Margarita Zeppeli - Zeppeli <b class='enabled-link-b'>Zeppeli</b> <b class='enabled-link-b'>Zeppeli </b> <b class='enabled-link-b'>death by <span onClick={()=>{
        corrupt(2);
    }} class='interactive enabled-link-r no-select-text'>crushing</span> runs in the family</b></li>
    <li style={{display: props.RitaCorruption>=12 ? 'list-item' : 'none'}}>Margarita Zeppeli - Zeppeli <b class='enabled-link-b'>Zeppeli</b> <b class='enabled-link-b'>Zeppeli </b> <b class='enabled-link-b'>death by <b style={{color: "red"}}>YOU CRUSHED HER</b> runs in the family</b></li>
    </ul>
    ...
    <h3 style={{display: props.RitaCorruption===12 ? 'block' : 'none'}} onClick={()=>{
        corrupt(2);
        window.scrollTo(0, 0);
    }} class='interactive enabled-link-r no-select-text'>Rockin' Robin</h3>
    <h3 style={{display: props.RitaCorruption>=14 ? 'block' : 'none'}} onClick={()=>{
        window.scrollTo(0, 0);
    }} class='interactive no-select-text'><i style={{color: 'crimson', textDecoration: 'underline'}}>Rockin' Robin</i></h3>
    ...
    <p style={{display: props.RitaCorruption===14 ? 'block' : 'none'}}>It's a bird and also a scythe. It can extend its legs very far (presumably infinitely). Its beak is strong and sharp, able to&nbsp; 
        <span onClick={()=>{
        corrupt(2);
    }} class='interactive enabled-link-r no-select-text'>deflect projectiles.</span> The Stand can also speak, repeat simple phrases, and mimic voices.
    </p>
    ...
    <b class='enabled-link-b'>she never wanted to accept how perfectly her Stand was made for killing.</b> The Stand can also speak, repeat simple phrases, and mimic voices.
    </p>
    ...
    <ul>
        ...
        corrupt(2);
    }} class='interactive enabled-link-r no-select-text'>Stand ‘Rock Lobster’,</span> Rockin’ Robin gained enhanced 
        speed and achieved full sentience.
        </li>
        <li style={{display: props.RitaCorruption===18 ? 'list-item' : 'none'}}>
        Notice of Stand Evolution: During an encounter with Crab Louie Zeppeli’s <b class='enabled-link-b'>you kept her from the truth</b>, Rockin’ Robin <span onClick={()=>{
        corrupt(2);
    }} class='interactive enabled-link-r no-select-text'>gained</span> enhanced 
        speed and achieved full sentience.
        </li>
        <li style={{display: props.RitaCorruption===20 ? 'list-item' : 'none'}}>
        Notice of Stand Evolution: During an encounter with Crab Louie Zeppeli’s <b class='enabled-link-b'>you kept her from the truth</b>, Rockin’ Robin&nbsp; 
        <b class='enabled-link-b'>because you thought her weak</b> enhanced 
        speed and <span onClick={()=>{
        corrupt(2);
    }} class='interactive enabled-link-r no-select-text'>achieved</span> full sentience.
        </li>
        <li style={{display: props.RitaCorruption===22 ? 'list-item' : 'none'}}>
        Notice of Stand Evolution: During an encounter with Crab Louie Zeppeli’s <b class='enabled-link-b'>you kept her from the truth</b>, Rockin’ Robin&nbsp; 
        <b class='enabled-link-b'>because you thought her weak</b> enhanced speed and <b class='enabled-link-b'>but she possessed the greatest potential <span onClick={()=>{
        corrupt(2);
    }} class='interactive enabled-link-r no-select-text'>out of all of</span> you</b> full sentience.
        </li>
        <li style={{display: props.RitaCorruption>=24 ? 'list-item' : 'none'}}>
        Notice of Stand Evolution: During an encounter with Crab Louie Zeppeli’s <b class='enabled-link-b'>you kept her from the truth</b>, Rockin’ Robin&nbsp; 
        <b class='enabled-link-b'>because you thought her weak</b> enhanced speed and <b class='enabled-link-b'>but she possessed the greatest potential <b style={{color: 'red'}}>except for</b> you</b> full sentience.
        </li>
    </ul>
    <h3>Hamon</h3>
    ...
    <p style={{display: props.RitaCorruption===24 ? 'block' : 'none'}}>Zeppeli possesses her family’s genetic predisposition <span onClick={()=>{
        corrupt(3);
    }} class='interactive enabled-link-r no-select-text'>to Hamon affinity.</span> She understands the basics of the breathing techniques, 
        although her lack of an experienced teacher has prevented her from learning advanced skills. These abilities are most useful 
        in conjunction with her Stand, which is also able to channel Hamon (and better than her), and provides her with a speed and 
        power boost while using her Stand.</p>
    <p style={{display: props.RitaCorruption===27 ? 'block' : 'none'}}>Zeppeli possesses her family’s genetic predisposition <b class='enabled-link-b'>Hamon... wait.</b> She understands the basics of the breathing techniques, 
        although her lack of an experienced teacher has prevented her from <span onClick={()=>{
        corrupt(4);
    }} class='interactive enabled-link-r no-select-text'>learning advanced skills.</span> These abilities are most useful 
        in conjunction with her Stand, which is also able to channel Hamon (and better than her), and provides her with a speed and 
        power boost while using her Stand.</p>
    <p style={{display: props.RitaCorruption===31 ? 'block' : 'none'}}>Zeppeli possesses her family’s genetic predisposition <b class='enabled-link-b'>Hamon... wait.</b> She understands the basics of the breathing techniques, 
        although her lack of an experienced teacher has prevented her from <b class='enabled-link-b'>don't tell me...</b> These abilities are most useful 
        in conjunction with her Stand, which is also able to channel Hamon (and better than her), and <span onClick={()=>{
        corrupt(5);
    }} class='interactive enabled-link-r no-select-text'>provides her with a speed and 
        power boost</span> while using her Stand.</p>
    <p style={{display: props.RitaCorruption>=36 ? 'block' : 'none'}}>Zeppeli possesses her family’s genetic predisposition <b class='enabled-link-b'>Hamon... wait.</b> She understands the basics of the breathing techniques, 
        although her lack of an experienced teacher has prevented her from <b class='enabled-link-b'>don't tell me...</b> These abilities are most useful 
        in conjunction with her Stand, which is also able to channel Hamon (and better than her), and <b class='enabled-link-b'>IT'S EXTENDING FASTER.</b> while using her Stand.</p>
    ...
    <h2 style={{display: props.RitaCorruption===36 ? 'block' : 'none'}}> <span onClick={()=>{
        corrupt(5);
    }} class='interactive enabled-link-r no-select-text'>Known Relationships</span></h2>
    <h2 style={{display: props.RitaCorruption>=41 ? 'block' : 'none'}}> <b class='enabled-link-b'>Skip ahead. No time. Small words.</b></h2>
    <ul>
    ...
    <h2 style={{display: props.RitaCorruption===41 ? 'block' : 'none'}}><span onClick={()=>{
        corrupt(5);
    }} class='interactive enabled-link-r no-select-text'>Psychological Profile</span></h2>
    <h2 style={{display: props.RitaCorruption>=46 ? 'block' : 'none'}}><b class='enabled-link-b'>Pick a word. Remember.</b></h2>
    ...
    <p>Rita is <span onClick={()=>{
        corrupt(4);
        lockout('Passionate');
    }} class='interactive enabled-link-r no-select-text'>passionate</span> and&nbsp;
    <span onClick={()=>{
        corrupt(4);
        lockout('Headstrong');
    }} class='interactive enabled-link-r no-select-text'>headstrong</span>. Raised from a young age to live life true to herself, she is&nbsp;
    <span onClick={()=>{
        corrupt(4);
        lockout('Unrelenting');
    }} class='interactive enabled-link-r no-select-text'>unrelenting</span> when she discovers perceived 
        injustice in the world. This can also make her&nbsp;
    <span onClick={()=>{
        corrupt(4);
        lockout('Brash');
    }} class='interactive enabled-link-r no-select-text'>brash</span> and tunnel-visioned, unable to unfocus herself from a task until it causes her 
        physical harm. Her mind moves fast, and at times, she struggles to properly articulate herself. Her Stand’s recent&nbsp;
        <span onClick={()=>{
        corrupt(4);
        lockout('Maturation');
    }} class='interactive enabled-link-r no-select-text'>maturation</span> and 
        ability to speak in lieu of Rita might be emblematic of this.</p>
    <h2>Author's Notes</h2>
    ...
    <span onClick={()=>{
        corrupt(4);
        lockout('Immature');
    }} class='interactive enabled-link-r no-select-text'>immature</span>,&nbsp;
    <span onClick={()=>{
        corrupt(4);
        lockout('Shortsighted');
    }} class='interactive enabled-link-r no-select-text'>shortsighted</span>, and&nbsp;
    <span onClick={()=>{
        corrupt(4);
        lockout('Irrational');
    }} class='interactive enabled-link-r no-select-text'>irrational</span>. I had intended to bring her up so she would survive the curse of her 
        family line, but she proved herself to be&nbsp;
        <span onClick={()=>{
        corrupt(4);
        lockout('Unbendable');
    }} class='interactive enabled-link-r no-select-text'>unbendable</span>. We did not get along as a result, such was more of&nbsp;
    <span onClick={()=>{
        corrupt(4);
        lockout('My Failure');
    }} class='interactive enabled-link-r no-select-text'>my failure</span> than hers; she needed 
        gentle guidance, something I was incapable of offering. But she has&nbsp;
        <span onClick={()=>{
        corrupt(4);
        lockout('Grown');
    }} class='interactive enabled-link-r no-select-text'>grown</span>, grown so much I hardly recognize her sometimes. And even though 
        I know I have no right to, I can’t help but feel proud. She is&nbsp; <br /> <br />
        <span onClick={()=>{
        corrupt(4);
        lockout('My Greatest Failure');
    }} class='interactive enabled-link-r no-select-text'>my greatest failure</span>,&nbsp; <br /> <br />
    <span onClick={()=>{
        corrupt(4);
        lockout('My Voice of Dissent');
    }} class='interactive enabled-link-r no-select-text'>my voice of dissent</span>,&nbsp; <br /> <br />
    <span onClick={()=>{
        corrupt(4);
        lockout('My Greatest Success');
    }} class='interactive enabled-link-r no-select-text'>my greatest success</span>.
    </p>
    </div>
    <p>
    ...
    <h4 onClick={()=>{
        window.scrollTo(0, 0);
    }} class='interactive no-select-text'><i style={{color: 'crimson', textDecoration: 'underline'}}>Tweet</i></h4>
    <h5 onClick={()=>{
        window.scrollTo(0, 0);
    }} class='interactive no-select-text'><i style={{color: 'crimson', textDecoration: 'underline'}}>Tweet</i></h5>
    <h6 onClick={()=>{
        window.scrollTo(0, 0);
    }} class='interactive no-select-text'><i style={{color: 'crimson', textDecoration: 'underline'}}>Tweet</i></h6>
    <h2>Known Relationships</h2>
    <p><b class='enabled-link-b'>Caesar
    {props.RitaName[0]}:</b> {props.RitaName[0]}
    <b class='enabled-link-b'><br />Zeppeli?
    {props.RitaName[0]}:</b> {props.RitaName[0]}
    <b class='enabled-link-b'>
    {props.RitaName[0]}:</b> {props.RitaName[0]}
    <br /> <b class='enabled-link-b'>Crab Louie
    {props.RitaName[0]}:</b> {props.RitaName[0]}
    <b class='enabled-link-b'>
    {props.RitaName[0]}:</b> {props.RitaName[0]}
    <b class='enabled-link-b'>
    ...
    <p><b class='enabled-link-b'>
        ...
        {props.RitaName[0]}
        {props.RitaName[0]}</p>
        <p><b class='enabled-link-b'>{props.RitaName[0]}</b><br />
        <b class='enabled-link-b'>{props.RitaName[0]}</b><br />
        <b class='enabled-link-b'>{props.RitaName[0]}</b><br />
        <b class='enabled-link-b'>{props.RitaName[0]}</b><br />
        <b class='enabled-link-b'>{props.RitaName[0]}</b><br />
